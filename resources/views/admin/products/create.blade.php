...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="w-1/2">
    ...
    <div class="mb-4">
        ...
        <input type="checkbox" name="is_active" id="is_active" class="shadow appearance-none border rounded text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="1" checked>
    </div>
