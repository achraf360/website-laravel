        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td class="py-2 px-4 border-b font-normal">
                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white py-1 px-2 rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                    <button wire:click="deleteCategory({{ $category->id }})" class="bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded"><i class="fa-solid fa-trash"></i></button>
                </td>
            </tr>
            @endforeach
            @endif
